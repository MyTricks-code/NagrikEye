                  ...
                  <div className="w-10 h-10 bg-black/5 rounded-full flex items-center justify-center group-hover:bg-[#8ED462] transition-colors">
                    ...
                    >
                      ...
                      <line x1="12" y1="3" x2="12" y2="15"></line>
                        ...
                        <div className="pt-4">
                            <button className="bg-black text-white px-8 py-3 rounded-full text-lg font-medium hover:bg-gray-800 transition-colors cursor-pointer" onClick={(e) => handleSubmit(e)}>
